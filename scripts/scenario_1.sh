...
nats req cc.commands.mutualcreditaccount "`cat create_account_cmd.json | jq -c`"
nats req cc.commands.mutualcreditaccount "`cat deposit_cmd_1.json | jq -c`"
nats req cc.commands.mutualcreditaccount "`cat deposit_cmd_2.json | jq -c`"
nats req cc.commands.mutualcreditaccount "`cat withdraw_cmd_1.json | jq -c`"
